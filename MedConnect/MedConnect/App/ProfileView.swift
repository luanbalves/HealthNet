            ...
            NavigationView {
                ScrollView(showsIndicators: false) {
                    VStack {
                        ...
                        ContentProfileView(headingImage: "play.rectangle", headingText: "Vídeos")
                        
                        ContentProfileView(headingImage: "newspaper", headingText: "Notícias")
                            .padding(.top)
                        
                        ContentProfileView(headingImage: "doc.plaintext", headingText: "Resumos")
                            .padding(.top)
                        
                        ContentProfileView(headingImage: "exclamationmark.bubble", headingText: "Dicas")
                            .padding(.top)
